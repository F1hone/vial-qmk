...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    RGB_TOG, KC_LCTL, KC_LALT, TL_LOWR,          KC_SPC,  KC_SPC,           TL_UPPR, KC_RGUI, KC_RALT, KC_RCTL
    ),
    /*
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───────┐
...
#define ID63_CAPS_LOCK_KEY_INDEX 0  // position of Caps Lock key
