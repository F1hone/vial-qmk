...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                  KC_SPC,                                       KC_RALT, TL_LOWR, SK_LT2A, KC_RCTL
    ),
    ...
    [_FN1] = LAYOUT_60_ansi(
        ...
        _______,          _______, _______, _______, KB_VRSN, QK_BOOT, NK_TOGG, _______, _______, _______,  _______,          KC_PGUP,
        _______, _______, _______,                   _______,                                     _______, MO(_FN3), KC_HOME, KC_PGDN
    ),
...
#define ID63_CAPS_LOCK_KEY_INDEX 45  // position of Caps Lock key
