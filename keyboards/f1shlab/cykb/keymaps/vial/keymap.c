...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_P7  , KC_P6  , KC_P9  , KC_P0  , KC_P1  , KC_PAST, KC_P3  , KC_P4  ,
                 KC_PGUP, KC_LWIN, KC_PGDN, KC_APP ,
        KC_F5  , KC_F9  ,          KC_F10 , KC_BSLS, KC_ENT , KC_SPC , KC_BSPC,
                 KC_DEL,           KC_F11 ,                   KC_DOWN,
        KC_UP  , KC_HOME,          KC_END,  MO(1),            KC_LEFT,
                 KC_INS ,          KC_F12 ,                   KC_RGHT, KC_NUM,
    ...
    [1] = LAYOUT(
        ...
        KC_MSTP, KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, BL_TOGG, KC_TRNS,  //3
                 KC_TRNS,          KC_TRNS,                   BL_DOWN,           //4
        BL_UP,   KC_PAUS,          KC_TRNS, KC_TRNS,          KC_VOLD,           //5
                 KC_SCRL,          KC_TRNS,                   KC_VOLU, KC_TRNS,  //6
